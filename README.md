Coaster Ride: A Roller Coaster Data Analysis
🎢 Project Overview
...
Speed & Performance
Examining maximum velocities across coasters to identify speed trends and how they've increased over time. The project analyzes whether modern engineering allows for consistently faster rides.
Height & Scale
Investigating the relationship between a coaster's maximum height and other performance metrics. Understanding whether taller coasters are inherently faster or if height serves other design purposes.
Inversions & Complexity
Studying the prevalence of inversions (loops and twists) as a design element and how their popularity has changed throughout coaster history. This reflects evolving safety standards and rider preferences.
Physical Forces (G-Forces)
